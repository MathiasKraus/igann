...
if task == 'regression':
    ...
    model_pool = {
        ...
        'ridge':
           [('1e-5', LogisticRegression(C=1e-5, penalty='l2')),
             ('1e-4', LogisticRegression(C=1e-4, penalty='l2')),
             ('1e-3', LogisticRegression(C=1e-3, penalty='l2')),
             ('1e-2', LogisticRegression(C=1e-2, penalty='l2')),
             ('1e-1', LogisticRegression(C=1e-1, penalty='l2')),
             ('1e0', LogisticRegression(C=1e0, penalty='l2')),
             ('1e1', LogisticRegression(C=1e1, penalty='l2')),
             ('1e2', LogisticRegression(C=1e2, penalty='l2')),
             ('1e3', LogisticRegression(C=1e3, penalty='l2')),
             ('1e4', LogisticRegression(C=1e4, penalty='l2'))],
        'gam':
            [('5_0.2', partial(terms.s, n_splines=5, lam=0.2)),
             ('5_0.5', partial(terms.s, n_splines=5, lam=0.5)),
             ('5_0.7', partial(terms.s, n_splines=5, lam=0.7)),
